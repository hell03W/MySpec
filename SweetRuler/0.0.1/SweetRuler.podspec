...
A slide ruler use to select some numbers, support Integer, Double. Write by swift-3.0. I hope this will give someone convenience.
  ...
  # Or just: s.author    = "weidf"
  # s.authors            = { "weidf" => "weidf@163.com" }
  ...
  s.source       = { :git => "https://github.com/hell03W/WHRuler.git", :commit => '5bbfd170f8cac72a4b4c86432b161f9905406e3c' }
  ...
  s.source_files  = "WHRuler", "WHRuler/WHRuler/*.*"
